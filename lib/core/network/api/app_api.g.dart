...
class _AppServiceClient implements AppServiceClient {
  ...
  @override
  Future<GetAllRegionsRsponse> getStoreRegionsService() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GetAllRegionsRsponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late GetAllRegionsRsponse _value;
    try {
      _value = GetAllRegionsRsponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<GetAllOrderResponse> getAllOrderService(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late GetAllOrderResponse _value;
    try {
      _value = GetAllOrderResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<ApiSuccessGeneralModel> canceledOrderService(String orderId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ApiSuccessGeneralModel>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          '/v1/api/driver/${orderId}/canceledOrder',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
